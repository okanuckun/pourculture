  ...
  return createPortal(
    <>
      <nav className="fixed top-8 left-4 md:left-8 z-[2000] flex items-center gap-0">
        {/* Logo */}
        <div className="bg-foreground text-background h-[34px] w-[34px] border-2 border-foreground flex items-center justify-center">
        ...
        <div className="hidden md:flex items-center">
          <Link 
            to="/" 
            className="relative overflow-hidden bg-background text-foreground h-[34px] px-3 flex items-center text-[11px] font-medium uppercase border-2 border-foreground leading-none group"
          >
        ...
        <button 
          ...
          className="md:hidden relative overflow-hidden bg-background text-foreground h-[34px] px-3 border-2 border-l-0 border-foreground flex items-center justify-center text-[11px] font-medium uppercase leading-none group"
        >
