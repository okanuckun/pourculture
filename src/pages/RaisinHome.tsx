    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground max-w-2xl">
                When looking for local, seasonal and organic restaurants, bars and wine shops, pourculture is your best option.
              </p>
            </div>
            <button 
      ...
      <footer className="py-12 px-4 md:px-8 border-t border-border">
        <div className="max-w-7xl mx-auto text-center text-muted-foreground text-sm">
          <p>© 2025 pourculture. Natural Wine & Food Lovers.</p>
        </div>
      </footer>
    </div>
  );
